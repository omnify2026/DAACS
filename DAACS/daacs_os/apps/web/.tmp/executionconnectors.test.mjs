...
// src/stores/cliLogStore.ts
var MAX_ENTRIES = 50;
var useCliLogStore = create((set) => ({
  entries: [],
  panelOpen: false,
  addEntry: (inEntry) => set((s) => ({
    entries: [
      {
        ...inEntry,
...
// src/lib/executionConnectors.ts
var CONNECTOR_GUIDANCE = {
  open_pull_request: [
...
// src/lib/executionConnectors.test.ts
...
var publishInstruction = buildExecutionConnectorInstruction(publishIntent);
assert(
...
var deployInstruction = buildExecutionConnectorInstruction(deployIntent);
assert(
...
var summary = summarizeConnectorOutput(
