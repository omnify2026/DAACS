import { extractFirstJsonObject, normalizeRoleLabel, } from "./agentDesignAssistant";
...
export function normalizeCompanyBuildPlan(value, availableSkills) {
    if (!value || typeof value !== "object")
        return null;
    const record = value;
...
export async function designCompany(request, skillCatalog) {
