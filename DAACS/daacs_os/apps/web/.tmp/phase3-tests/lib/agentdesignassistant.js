...
exports.normalizeRoleLabel = normalizeRoleLabel;
exports.extractFirstJsonObject = extractFirstJsonObject;
exports.normalizeBlueprintSuggestion = normalizeBlueprintSuggestion;
exports.suggestAgentBlueprint = suggestAgentBlueprint;
...
function normalizeRoleLabel(value, fallback = "suggested_agent") {
...
async function suggestAgentBlueprint(intent, availableSkills) {
    if (!(0, tauriCli_1.isTauri)() || !intent.trim() || availableSkills.length === 0) {
        return null;
    }
    try {
        const architectPrompt = await (0, tauriCli_1.getSkillPromptForCustom)("agent_architect", [
            "ai-agents-architect",
        ...
        const systemPrompt = [
            ...
            .filter(Boolean)
            .join("\n\n---\n\n");
        const result = await (0, tauriCli_1.runCliCommand)(`Design a DAACS custom agent for this intent:\n${intent.trim()}`, {
