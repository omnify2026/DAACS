...
const companyBuilder_1 = require("./companyBuilder");
...
const plan = (0, companyBuilder_1.normalizeCompanyBuildPlan)({
...
assert(plan?.agents[0].selected_skills[0] === "ai-agents-architect", "selected skills should normalize to catalog IDs");
