import { attachHandoffsToInput, handoffToNextAgent } from "./agentHandoff";
import type {
  ExecutionStep,
...
const handoff = handoffToNextAgent(
  ...
  completedStep,
  nextStep,
  "Payment endpoint is ready for review.",
);
...
const merged = attachHandoffsToInput({ draft: true }, [handoff]) as {
  handoff_messages?: unknown[];
};
